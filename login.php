	...
	<div id="page-container" class="fade">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 text-center mt-xl-5 mt-5" align="center">
                <h3 style="color:#e91e63;font-weight:700;font-size:30px">Admin Library YRC</h3>
					...
					<?php }?>
                        ...
                        <form action="process/login.php" method="post" >
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Username" name="u_username" id="u_username" required>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control" placeholder="Password" name="u_password" id="u_password" required>
                            </div>
