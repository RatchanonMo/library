                ...
                <?php
                    ...
                    while($row = mysqli_fetch_array($result2)){
						...
						echo'<tr>';
                            ...
                            echo"<td><a href=datail-student2.php?id=$row[0] class='btn btn-orange' style='font-weight:unset'>ผู้ยืม</a></td>";
                            echo"<td><a href=process/default-book.php?id=$row[0] class='btn btn-danger' style='font-weight:unset'>คืน</a></td>";
                            echo'</tr>';
